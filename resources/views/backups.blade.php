...
<body class="flex h-screen bg-[#F8FAFC] font-sans text-slate-900 overflow-hidden">
  ...
  <div class="flex-1 flex flex-col h-full overflow-hidden w-full relative">
      ...
      <div class="flex items-center gap-4">
        ...
        <div>
          <div class="flex items-center gap-2 text-xs font-bold text-slate-400 uppercase tracking-widest mb-1">
            <span>IT Infrastructure</span> / <span class="text-blue-500">Data Retention</span>
          </div>
          <h1 class="text-2xl md:text-3xl font-black text-slate-800 tracking-tight">System Backups</h1>
        </div>
      </div>
    </header>
    ...
    <main class="p-4 md:p-8 flex-1 overflow-y-auto space-y-8 pb-20">
      ...
      <div class="bg-white p-8 rounded-3xl shadow-sm border border-slate-200/60 flex flex-col md:flex-row justify-between items-center gap-6">
        <div>
            <h2 class="text-lg font-black text-slate-800">Generate Database Dump</h2>
            <p class="text-sm text-slate-500 font-medium mt-1">Create an immediate .sql snapshot of all environmental logs and system configurations.</p>
        </div>
        <button class="w-full md:w-auto px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white font-black uppercase tracking-widest text-xs rounded-xl shadow-lg shadow-blue-600/30 transition-all flex items-center justify-center gap-2">
      ...
      <div class="bg-white rounded-3xl shadow-sm border border-slate-200/60 overflow-hidden">
        <div class="p-6 border-b border-slate-100">
            <h3 class="font-black text-slate-800 text-lg">Recent Archive Files</h3>
        </div>
        <div class="divide-y divide-slate-100">
            <div class="p-6 flex items-center justify-between hover:bg-slate-50 transition-colors group">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <div class="text-sm font-bold text-slate-800">aegis_db_backup_2026_05_07.sql</div>
                        <div class="text-xs text-slate-400 font-bold uppercase tracking-widest mt-1">System generated • 24.5 MB</div>
                    </div>
                </div>
                <button class="text-blue-600 font-black text-[10px] uppercase tracking-widest hover:text-blue-800 transition-colors bg-blue-50 px-4 py-2 rounded-lg">Download</button>
            </div>
            <div class="p-6 flex items-center justify-between hover:bg-slate-50 transition-colors group">
                <div class="flex items-center gap-4">
                    <div class="w-12 h-12 bg-slate-100 text-slate-500 rounded-xl flex items-center justify-center"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg></div>
                    <div>
                        <div class="text-sm font-bold text-slate-800">aegis_db_backup_2026_05_01.sql</div>
                        <div class="text-xs text-slate-400 font-bold uppercase tracking-widest mt-1">System generated • 22.1 MB</div>
                    </div>
                </div>
                <button class="text-slate-500 font-black text-[10px] uppercase tracking-widest hover:text-blue-600 transition-colors px-4 py-2">Download</button>
            </div>
        </div>
      </div>
    </main>
